                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${list}" var="room">
                                <tr class="text-center">
                                    ...
                                    <td>${room.status}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/updateRoom/${room.id}'/>">Sửa</a>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/deleteRoom/${room.id}'/>">Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
