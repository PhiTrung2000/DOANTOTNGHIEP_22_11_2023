                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <c:forEach items="${listRoom}" var="category">
                                <tr class="text-center">
                                    <td>${category.id}</td>
                                    <td>${category.bed}</td>
                                    <td>${category.name}</td>
                                    <td>${fn:replace(category.numOfPeople, '.0', '')}</td>
                                    <td>${fn:replace(category.price, '.0', '')}</td>
                                    <td>${category.status}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/update/${category.id}'/>">Sửa</a>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/delete/${category.id}'/>">Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
