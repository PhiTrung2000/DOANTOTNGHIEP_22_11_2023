                  ...
                  <div class="card-body">
                    ...
                    <form action="${action}" method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Số Phòng" value="${room.name}" required>
                      </div>
                      <div class="form-group">
                        <label for="status">Tình trạng</label>
                        <select style="color: black;" class="form-control form-control-sm" id="status" name="status" value=${room.status}>
