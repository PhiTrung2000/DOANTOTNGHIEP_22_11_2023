              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="addRoom" method="post" class="forms-sample">
                      <div class="form-group">
                        <label for="name">Số phòng</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Số phòng" required >
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="categoryId">Tên Loại Phòng</label>
