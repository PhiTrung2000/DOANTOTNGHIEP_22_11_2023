...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
                  ...
                  <div class="card-body">
                    ...
                    <form action="${action}" method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="bed" name="bed" placeholder="Số giường" value=${category.bed} required >
                      </div>
                      <div class="form-group">
                        <label for="name">Tên phòng</label>
                        <select class="form-control form-control-sm" id="name" name="name" style="color: black">
                      ...
                      <div class="form-group">
                        <label for="numOfPeople">Số lượng người</label>
                        <input type="number" class="form-control" id="numOfPeople" name="numOfPeople" placeholder="Số lượng người" value=${Math.round(category.numOfPeople)} required>
                      </div>
                      <div class="form-group">
                        <label for="price">Giá</label>
                        <input type="number" class="form-control" id="price" name="price" placeholder="Giá" value=${Math.round(category.price)} required>
                      </div>
                      <div class="form-group">
                        <label for="status">Tình trạng</label>
                        <select class="form-control form-control-sm" id="status" name="status" style="color: black">
                            <option>Available</option>
                            <option>NoAvailable</option>
                      </select>
                      </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("name").value = selectedCategory;
        });
    </script>

    <script>
            document.addEventListener("DOMContentLoaded", function () {
                var selectedCategory = "${category.status}";
                document.getElementById("status").value = selectedCategory;
            });
    </script>
