                  ...
                  <div class="card-body">
                    ...
                    <form action="addDiscount" method="post" class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="code" name="code" placeholder="Mã Khuyến Mãi" required >
                      </div>
                      <div class="form-group">
                        <label for="discountAmount">Khuyến Mãi</label>
                        <input type="number" class="form-control" id="discountAmount" name="discountAmount" placeholder="Khuyến Mãi" required>
                      </div>
                      <div class="form-group">
                        <label for="expirationDate">Hạn Sử Dụng</label>
                        <input type="date" class="form-control" id="expirationDate" name="expirationDate" placeholder="Hạn Sử Dụng" required>
                      </div>
                      <div class="form-group">
                        <label for="name">Mô tả</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Mô tả" required>
                      </div>
                      <input type="submit" value="Thêm Khuyến Mãi" class="btn btn-gradient-primary me-2"></button>
                    </form>
                  </div>
                </div>
              </div>
