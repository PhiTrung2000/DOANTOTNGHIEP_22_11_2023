                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${listDiscount}" var="discount">
                                <tr class="text-center">
                                    <td>${discount.id}</td>
                                    <td>${discount.code}</td>
                                    <td>${fn:replace(discount.discountAmount, '.0', '')}%</td>
                                    <td><fmt:formatDate value="${discount.expirationDate}" pattern="dd-MM-yyyy" /></td>
                                    <td>${discount.name}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/updateDC/${discount.id}'/>">Sửa</a>
                                        <a class="btn btn-primary btn-sm" href="<c:url value='/admin/delDS/${discount.id}'/>">Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
