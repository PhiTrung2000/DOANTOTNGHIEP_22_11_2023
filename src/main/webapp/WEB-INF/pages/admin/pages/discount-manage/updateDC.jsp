                  ...
                  <div class="card-body">
                    ...
                    <form action="${action}" method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="code" name="code" placeholder="Mã" value=${discountinfo.code} required>
                      </div>
                      <div class="form-group">
                        <label for="discountAmount">Giảm Giá</label>
                        <input type="number" class="form-control" id="discountAmount" name="discountAmount" placeholder="Giảm Giá" value=${Math.round(discountinfo.discountAmount)} required>
                      </div>
                      <div class="form-group">
                        <label for="expirationDate">Ngày hết hạn</label>
                        <input type="text" class="form-control" id="expirationDate" name="expirationDate" placeholder="Ngày hết hạn" value=${discountinfo.expirationDate} required>
                      </div>
                      <div class="form-group">
                        <label for="code">Mô tả</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Mô tả" value="${discountinfo.name}" required>
                      </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            flatpickr(expirationDateInput, {
                ...
                defaultDate: new Date('${discountinfo.expirationDate}'), // Giá trị mặc định
            });
        });
    </script>
  </body>
