      ...
      <section class="section">
            <div class="container">
              <div class="row    justify-content-center text-center mb-5">
                 <h2 class="mb-4"> <b>Phòng Family</b> </h2>
                        <p>Phòng Family là sự kết hợp hoàn hảo giữa không gian thoải mái và tiện nghi đẳng cấp, là lựa chọn tuyệt vời cho gia đình hoặc nhóm bạn với 3-4 thành viên. Với diện tích rộng rãi và bố trí linh hoạt, phòng Family mang lại cảm giác ấm cúng và thoải mái như ở nhà.</p><br>
                         </div>
              </div>
              <div class="row">
                  ...
                  <a href="#" class="room">
                   ...
                   <div style="margin-left:80px ; color:black" class="text order-1">
                                       ...
                                       <p>Tiện ích:</br></br>
                                         ...
                                         Phòng Family chỉ dành cho 3-4 người, giúp bạn có những khoảnh khắc đáng nhớ cùng gia đình và người thân. Hãy đặt phòng Family ngay hôm nay để trải nghiệm không gian ấm áp và đẳng cấp tại khách sạn chúng tôi!</p>
                                     </div>
                  </a>
                </div>
