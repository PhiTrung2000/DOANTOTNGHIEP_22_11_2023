      ...
      <div class="container">
        ...
        <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="100">
          ...
          <div class="text">
            ...
            <p>Phòng Family là sự kết hợp hoàn hảo giữa không gian thoải mái và tiện nghi đẳng cấp, là lựa chọn tuyệt vời cho gia đình hoặc nhóm bạn với 3-4 thành viên. Với diện tích rộng rãi và bố trí linh hoạt, phòng Family mang lại cảm giác ấm cúng và thoải mái như ở nhà.</p>
            <p><a href="/user/booking/Family" class="btn btn-primary text-white">Đặt Phòng</a></p>
          </div>
        </div>
          <div class="text order-1">
            ...
            <p>Tiện ích:</br></br>
              ...
              1. Kích thước lớn: Phòng Family rộng rãi và thoải mái, đảm bảo mọi thành viên trong gia đình đều có không gian riêng tư.</br>
              2. Nội thất hiện đại: Nội thất và trang thiết bị hiện đại, mang lại trải nghiệm sống đẳng cấp và tiện nghi.</br></br>

              Lưu ý đặc biệt:</br></br>

              Phòng Family chỉ dành cho 3-4 người, giúp bạn có những khoảnh khắc đáng nhớ cùng gia đình và người thân.
              Hãy đặt phòng Family ngay hôm nay để trải nghiệm không gian ấm áp và đẳng cấp tại khách sạn chúng tôi!</p>
          </div>
